                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <ul class="dropdown-menu__section">
                                                ...
                                                <li><a class="dropdown-item" href="#">become an partner</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="campaign-section__block">
                    ...
                    <form>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="exampleInputGoal1">add your goal<sup>*</sup></label>
                                    <input type="text" placeholder="amount" id="exampleInputGoal1">
                                </div>
                            </div>
                            <div class="col-lg-5">
                                <div class="form-group">
                                    <label for="exampleInputTitle1">campaign title<sup>*</sup></label>
                                    <input type="text" id="exampleInputTitle1" placeholder="campaign title">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="exampleInputZip1">zip code<sup>*</sup></label>
                                    <input type="text" id="exampleInputZip1" placeholder="zip code">
                                </div>
                            </div>
                        </div>
                        <p>person's photo<sup>*</sup></p>
                        <div class="row">
                        ...
                        <div class="campaign-text__section">
                            <div class="form-group">
                                <label for="exampleInputStory1">tell us your story<sup>*</sup></label>
                                <textarea id="exampleInputStory1" rows="6" placeholder="campaign story"></textarea>
                            </div>
                        </div>
                        ...
                        <iframe width="600" height="450" frameborder="0" style="border:0" src="//www.google.com/maps/embed/v1/place?q=place_id:ChIJ-Y7t-qm02IcRW-C7IsrqOb4&key=AIzaSyDYvsDWu0JLe4ATS1dVYnltzaOF13tomaA
" allowfullscreen>
                    </iframe>
