            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="withdraw-overview">
                        <ul>
                            ...
                            <li class="withdraw-active"><a href="#0">3. funds transfer method</a></li>
                ...
                <div class="col-lg-7">
                    <div class="withdraw-section">
                        ...
                        <p>now lets verify where the funds are going.</p>
                        <div class="withdraw-block">
                            <input type="text" placeholder="my funeral home">
                            <input type="text" placeholder="my account">
                            <div class="withdraw-block__text">
                                <h3>funds transfered to funeral home.</h3>
                                <p>any extra funds above the funeral costs will be sent to your account.</p>
                            </div>
                            <input type="number" placeholder="account number">
                            <input type="number" placeholder="bank name">
                            <input type="number" placeholder="ABA routing number">
